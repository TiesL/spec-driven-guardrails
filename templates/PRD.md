...
<!-- nfr-block:begin — generated by ./genereer-prd-blok, don't edit by hand -->
...
external dependencies (see an architecture requirement in `ARCHITECTUUR.md` if
one exists)?>
...
<How do `PRD.md`/`ARCHITECTUUR.md` stay current as the implementation changes?
