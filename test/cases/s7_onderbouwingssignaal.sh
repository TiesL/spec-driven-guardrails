...
# Given: een vers geadopteerd project met 18 geseede rijen die "vereist
# onderbouwing" dragen.
project="$(vers_project doelproject)"
adopteer "$project"

rijen="$(grep -c 'vereist onderbouwing' "$project/WORKFLOW-ADOPTIE.md")"
[ "$rijen" -eq 19 ] || fail "S7 — $rijen rijen met 'vereist onderbouwing', 19 verwacht"
...
# En het aantal beweegt mee: één rij onderbouwen maakt er achttien van.
