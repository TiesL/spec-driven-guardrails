...
[ "$rijen" -eq 17 ] || fail "S7 — $rijen rijen met 'vereist onderbouwing', 17 verwacht"
...
# En het aantal beweegt mee: één rij onderbouwen maakt er zestien van.
